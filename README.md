## Awesome cross-domain papers collections relating to Image Retrieval
An updated,exteneded version of awesome-cbir-papers. 
...
- [A Benchmark on Tricks for Large-scale Image Retrieval](https://arxiv.org/pdf/1907.11854.pdf)
- [Learning with Average Precision: Training Image Retrieval with a Listwise Loss](https://arxiv.org/pdf/1906.07589v1.pdf)
- [MultiGrain: a unified image embedding for classes and instances](https://arxiv.org/abs/1902.05509)，Hervé Jégou, Andrea Vedaldi, Matthijs Douze
...
#### Local Feature Based (Non-Deep Learning based methods)
...
- [Aggregating Deep Convolutional Features for Image Retrieval](https://arxiv.org/abs/1510.07493),(https://zhuanlan.zhihu.com/p/23136747), (https://zhuanlan.zhihu.com/p/22265265).
...
- [Combining Fisher Vector and Convolutional Neural Networks for Image Retrieval](http://ceur-ws.org/Vol-1653/paper_19.pdf),
...
#### Ranking and Searching algorithms
...
#### Image retrieval in productions
...
- [ImageCLEF-2020](https://www.imageclef.org/wikidata), ImageCLEF Wikipedia Image Retrieval Datasets.
- [DeepFashion2-2019](https://github.com/switchablenorms/DeepFashion2), DeepFashion2 is a comprehensive fashion dataset.
- [iMaterialist-2019](https://www.kaggle.com/c/imaterialist-product-2019) , iMaterialist Challenge on Product Recognition Fine-grained image classification of products at FGVC6, CVPR2019
